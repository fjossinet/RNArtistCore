...
Once the container installed, you can use the file ```rnartistcore.sh``` to run your DSL scripts. 

**Important:** the output file names generated by your DSL scripts have to be prefixed with ```/output/```. 
...
```./rnartistcore.sh /absolute_path_of_your_script/my_dsl_script.kts```

You will find the output files in the directory containing your DSL script.
