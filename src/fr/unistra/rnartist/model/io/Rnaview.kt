...
import static fr.unistra.rnartist.model.io.ParsersKt.parseRnaml;
...
import static fr.unistra.rnartist.model.io.UtilsKt.getUserDir;
        ...
        if (System.getProperty("os.name").equals("Windows 10")) {
            try {
                ...
                if (!destFile.exists()) {
                        ...
                        URL inputUrl = Rnaview.class.getResource("/fr/unistra/ibmc/rnartist/model/io/rnaview.bat");
